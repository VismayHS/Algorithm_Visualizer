...
function SplashCursor({
  ...
  useEffect(() => {
      ...
      const material = {
        ...
        setKeywords(keywords) {
          ...
          if (program == null) {
            ...
            program = createProgram(material.vertexShader, fragmentShader)
    ...
    function createProgramWrapper(vertexShader, fragmentShader) {
    ...
    const gradientSubtractProgram = createProgramWrapper(baseVertexShader, gradientSubtractShader)
    ...
    function updateColors(dt, colorUpdateTimerRef) {
    ...
    const colorUpdateTimerRef = { value: 0 }
    ...
    function handleTouchStart(event) {
      ...
      for (let index = 0; index < touches.length; index += 1) {
        const posX = scaleByPixelRatio(touches[index].clientX)
        const posY = scaleByPixelRatio(touches[index].clientY)
